...
export default function Post({post}: PostProps) {
    ...
    const convexCurrentUser = useQuery(api.users.getUserByClerkId, user ? {clerkId: user?.id} : "skip");
    ...
    return (
        <View style={styles.post}>
            <View style={styles.postHeader}>
                <Link href={
                    convexCurrentUser?._id === post.author._id ? "/(tabs)/profile" : `/user/${post.author._id}`
                } asChild>
